    ...
    switch (name) {
      ...
      case EndpointsNames.device:
        return EndPoint(
            name: name,
            method: 'POST',
            url: '${AppConstants.baseUrl}/rm_users/v1/device');
      ...
      case EndpointsNames.logOut:
        return EndPoint(
            name: name,
            method: 'POST',
            url: '${AppConstants.baseUrl}/rm_users/v1/log_out');
      case EndpointsNames.startApp:
        return EndPoint(
            name: name,
            method: 'POST',
            url: '${AppConstants.baseUrl}/rm_users/v1/start_app');
      ...
      case EndpointsNames.home:
        return EndPoint(
            name: name,
            method: 'GET',
            url: '${AppConstants.baseUrl}/rm_screens/v1/home');
      case EndpointsNames.pointsHistory:
        return EndPoint(
            name: name,
            method: 'GET',
            url: '${AppConstants.baseUrl}/rm_pointsys/v1/history');
      ...
      case EndpointsNames.addNew:
        return EndPoint(
            name: name,
            method: 'POST',
            url: '${AppConstants.baseUrl}/rm_pointsys/v1/add_new');
      ...
      case EndpointsNames.pages:
        return EndPoint(
            name: name,
            method: 'GET',
            url: '${AppConstants.baseUrl}/rm_page/v1/get');
      ...
      case EndpointsNames.deviceSys:
        return EndPoint(
            name: name,
            method: 'POST',
            url: '${AppConstants.baseUrl}/rm_users/v1/device_sys');
      ...
      case EndpointsNames.managerAction:
        return EndPoint(
            name: name,
            method: 'POST',
            url: '${AppConstants.baseUrl}/emp_requests/v1/action');
      ...
      case EndpointsNames.getEmployeeBalance:
        return EndPoint(
            name: name,
            method: 'GET',
            url: '${AppConstants.baseUrl}/emp_requests/v1/balance');
      ...
      case EndpointsNames.empTasks:
        return EndPoint(
            name: name,
            method: 'GET',
            url: '${AppConstants.baseUrl}/emp_requests/v1/task');
      ...
      case EndpointsNames.tasksUsers:
        return EndPoint(
            name: name,
            method: 'GET',
            url: '${AppConstants.baseUrl}/emp_requests/v1/users');
      ...
      case EndpointsNames.payGetPosts:
        return EndPoint(
            name: name,
            method: 'GET',
            url: '${AppConstants.baseUrl}/rm_payroll/v1/payroll');
      ...
      case EndpointsNames.addNewNotification:
        return EndPoint(
            name: name,
            method: 'POST',
            url: '${AppConstants.baseUrl}/rm_notification/v1');
      ...
      case EndpointsNames.resend:
        return EndPoint(
            name: name,
            method: 'POST',
            url: '${AppConstants.baseUrl}/rm_users/v1/2fa/resend');
      case EndpointsNames.oauth:
        return EndPoint(
            name: name,
            method: 'POST',
            url: '${AppConstants.baseUrl}/rm_users/v1/oauth');
