...
import 'package:orient/modules/authentication/view_models/login.viewmodel.dart';
...
class _CreateAccountModalState extends State<CreateAccountModal> {
  ...
  Widget build(BuildContext context) {
    ...
    ], child: Consumer<AuthenticationViewModel>(builder: (context, authenticationViewModel, child) {
