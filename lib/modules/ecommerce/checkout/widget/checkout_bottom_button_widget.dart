          ...
          return Container(
              ...
              child: Column(
                children: [
                  ...
                  if(value.updateCartModel != null && value.updateCartModel!.cart!.feesTotal != null && value.updateCartModel!.cart!.feesTotal != 0)Container(
                    height: 18,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        ...
                        Text("${value.updateCartModel!.cart!.feesTotal} ${LocalizationService.isArabic(context: context)? "جنيه" : "ُEGP"}".toUpperCase(), style: const TextStyle(fontWeight: FontWeight.w400, fontSize: 13, color: Color(0xff464646)),),
                      ],
                    ),
                  ),
                  if(value.updateCartModel == null &&value.checkoutFees != null && value.checkoutFees != 0) Container(
                    height: 18,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                  ...
                  if(value.updateCartModel == null &&value.checkoutDiscountTotal != null && value.checkoutDiscountTotal != 0) Container(
                    height: 18,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                  ...
                  if(value.updateCartModel != null &&value.updateCartModel!.cart!.discountTotal != null && value.updateCartModel!.cart!.discountTotal != 0) Container(
                    height: 18,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(AppStrings.discount.tr().toUpperCase(), style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 12, color: Color(0xff0D3B6F)),),
                        Text("-${value.updateCartModel!.cart!.discountTotal} ${LocalizationService.isArabic(context: context)? "جنيه" : "ُEGP"}".toUpperCase(), style: const TextStyle(fontWeight: FontWeight.w400, fontSize: 13, color: Color(0xff464646)),),
                      ],
                    ),
                  ),
                  if(value.updateCartModel == null &&value.checkoutTax != null && value.checkoutTax != 0) Container(
                    height: 18,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                  ...
                  if(value.updateCartModel != null &&value.updateCartModel!.cart!.taxesTotal != null && value.updateCartModel!.cart!.taxesTotal != 0) Container(
                    height: 18,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(AppStrings.tax.tr().toUpperCase(), style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 12, color: Color(0xff0D3B6F)),),
                        Text("${value.updateCartModel!.cart!.taxesTotal.toDouble().toStringAsFixed(2)} ${LocalizationService.isArabic(context: context)? "جنيه" : "ُEGP"}".toUpperCase(), style: const TextStyle(fontWeight: FontWeight.w400, fontSize: 13, color: Color(0xff464646)),),
                      ],
                    ),
                  ),
                  if(value.updateCartModel == null &&value.checkoutShipping != null && value.checkoutShipping != 0) Container(
                    height: 18,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                  ...
                  if(value.updateCartModel != null &&value.updateCartModel!.cart!.shippingCost != null && value.updateCartModel!.cart!.shippingCost != 0) Container(
                    height: 18,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(AppStrings.shippingCost.tr().toUpperCase(), style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 12, color: Color(0xff0D3B6F)),),
                        Text("${value.updateCartModel!.cart!.shippingCost} ${LocalizationService.isArabic(context: context)? "جنيه" : "ُEGP"}".toUpperCase(), style: const TextStyle(fontWeight: FontWeight.w400, fontSize: 13, color: Color(0xff464646)),),
                      ],
                    ),
                  ),
                  Spacer(),
