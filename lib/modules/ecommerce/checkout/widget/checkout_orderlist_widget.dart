              ...
              itemBuilder: (context, index)=> ListTile(
                ...
                subtitle: Row(
                  children: [
                    ...
                    if(value.updateCartModel !=null)Text(
                     (value.updateCartModel!.cart!.items![index].price != null && value.updateCartModel!.cart!.items![index].priceAfterDiscount != value.updateCartModel!.cart!.items![index].price)?
                      '${value.updateCartModel!.cart!.items![index].price} ${LocalizationService.isArabic(context: context)? "جنيه" : "ُEGP"} × ${value.updateCartModel!.cart!.items![index].quantity}':
                      "",
                      style: TextStyle(
