            ...
            child: ListView.separated(
                ...
                itemBuilder: (context, index)=>GestureDetector(
                  onTap: (){
                    ...
                    if(value.updateCartModel == null){
                      setState(() {
                        CheckConst.selectedPaymentId =
                        value.checkoutPaymentMethods[index]['id'];
                      });
                      ...
                      setState(() {
                        CheckConst.selectedPaymentId =
                            value.updateCartModel!.paymentMethod![index].id;
                      });
                      if(CheckConst.selectedAddressId != null && CheckConst.selectedPaymentId != null) {
                        value.updateCart(
                            context: context,
                            address_id: value.updateCartModel!.cart!.addressId,
                            payment_method_id: CheckConst.selectedPaymentId
                        );
                      }if(CheckConst.userAddressModel!.id != null && CheckConst.selectedPaymentId != null) {
                        value.updateCart(
                  ...
                  child: (value.updateCartModel == null)?Container(
                    height: 48,
                    child: Row(
                      children: [
                        CachedNetworkImage(
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        CachedNetworkImage(
                            imageUrl: (value.updateCartModel!.paymentMethod![index].logo!.isNotEmpty)?
                            value.updateCartModel!.paymentMethod![index].logo![0].file!:"",
                            fit: BoxFit.cover,
                            height: 30,
                            width: 30,
                            placeholder: (context,
                        ...
                        SizedBox(width: 10),
                        Text("${value.updateCartModel!.paymentMethod![index].title}",
                          style: const TextStyle(
                              color: Color(0xff464646),
                              fontWeight: FontWeight.w400,
                              fontSize: 12
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              color: (CheckConst.selectedPaymentId == value.updateCartModel!.paymentMethod![index].id)?const Color(0xff027FEE) : Colors.transparent,
                              border: Border.all(color:const Color(0xff027FEE) )
                          ),
                        )
                      ],
                ...
                itemCount: (value.updateCartModel == null)?value.checkoutPaymentMethods.length : value.updateCartModel!.paymentMethod!.length
            ),
          );
        },
    );
