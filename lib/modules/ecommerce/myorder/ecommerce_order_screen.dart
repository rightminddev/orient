              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: ListView.separated(
                      ...
                      itemBuilder: (context, index) =>(!value.isLoading)? Container(
                        decoration: BoxDecoration(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(AppStrings.delivered.tr().toUpperCase(), style: const TextStyle(color: Color(0xff2AA952), fontSize: 14, fontWeight: FontWeight.w500),),
                              ],
                            )
                          ],
                        ),
                      ):const GetMyorderLoading(),
