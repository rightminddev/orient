...
class ECommerceSearchScreen extends StatefulWidget {
  var categoryId;
  var categoryName;
  String painter = "false";
  final bool viewArrow;
  ECommerceSearchScreen({this.categoryId, required this.viewArrow, required this.categoryName, required this.painter});
  @override
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                              children: [
                                ...
                                SearchCategoryWidget(widget.painter),
                                const SizedBox(
                                  height: 20,
                                ),
                                SearchProductGridviewWidget(widget.painter),
                                const SizedBox(
                                  height: 15,
                                ),
