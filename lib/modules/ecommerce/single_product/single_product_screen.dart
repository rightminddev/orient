...
class EcommerceSingleProductDetailScreen extends StatefulWidget {
  final int id;
  var viewPrice;
  EcommerceSingleProductDetailScreen(@required this.id,@required this.viewPrice);
  @override
    ...
    child: Consumer<SingleProductProvider>(
      ...
      SafeArea(
          child: Scaffold(
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 20),
                            if(widget.viewPrice == "true") const SingleChangeCountWidget(),
                            const SizedBox(
                              height: 30,
                            ),
                            defaultTapBarItem(
              ...
              bottomNavigationBar:(widget.viewPrice == "true")?(singleProductProvider.singleProductModel == null)?Container(height: 136,) :
