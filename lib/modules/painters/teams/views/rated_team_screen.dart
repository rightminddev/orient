...
import 'package:orient/modules/painters/teams/views/widgets/custom_rated_team_section.dart';
import 'package:orient/modules/painters/teams/views/widgets/custom_teams_appbar.dart';
import 'package:orient/modules/painters/teams/views/widgets/rated_teams_list_view_item.dart';
...
class _RatedTeamScreenState extends State<RatedTeamScreen> {
  ...
  void initState() {
    ...
    viewModel.initializeTopRated(context);
  }
