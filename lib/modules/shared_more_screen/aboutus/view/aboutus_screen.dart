...
class _AboutUsScreenState extends State<AboutUsScreen> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(create: (context) => AboutUsLogicProvider()..getAboutUs(context),
                ...
                body: SingleChildScrollView(
                  child: Column(
                    children: [
                     ...
                     if(value.aboutUsModel != null) Padding(
                       padding: const EdgeInsets.symmetric(horizontal: 15),
                       child: (selectIndex == 0)?
                       Text(value.aboutUsModel!.page!.content!,
                       ...
                       ):(selectIndex == 1)?Text(value.aboutUsModel!.page!.history!,
                       textAlign: TextAlign.center,
                         style: const TextStyle(
                         fontWeight: FontWeight.w400,
                         color: Color(0xffFFFFFF),
                         ...
                         child: GridView.builder(
                                 ...
                                 itemCount: value.aboutUsModel!.page!.certificates!.length,
                                 ...
                                 child: CachedNetworkImage(
                                   imageUrl: value.aboutUsModel!.page!.certificates![index].file??"",
                                   fit: BoxFit.fill,
                         ...
                         child: GridView.builder(
                           ...
                           itemCount: value.aboutUsModel!.page!.partners!.length,
                           itemBuilder: (context, index) {
                             return Container(
                               decoration: BoxDecoration(
                                 color: Colors.white,
                               ...
                               child: Padding(
                                   padding: const EdgeInsets.all(12.0),
                                   child: CachedNetworkImage(
                                     imageUrl: value.aboutUsModel!.page!.partners![index].file??"",
                                     fit: BoxFit.fill,
                                     placeholder: (context, url) =>
                                     const ShimmerAnimatedLoading(),
                                     errorWidget: (context, url, error) => const Icon(
