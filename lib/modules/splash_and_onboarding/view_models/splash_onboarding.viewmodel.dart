      ...
      if (await ConnectionsService.isOnline()) {
        ...
        if (appConfigService.isLogin && appConfigService.token.isNotEmpty) {
          ...
          if (features == null || features.isEmpty) {
            ...
            print(gCache);
           //print("IS THIS --> ${safeParseDateTime(CacheHelper.getString("dateWatchScreen")).isAfter(safeParseDateTime(gCache['features']['date']))}");
           // print("features is --> ${safeParseDateTime(gCache['features']['date'])}");
            if (CacheHelper.getString("dateWatchScreen") == null ||CacheHelper.getString("dateWatchScreen") == "" ||
