        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
                ...
                spreadRadius: 0,
                offset: const Offset(0, 1),blurRadius: 10)],
        ),
        child: Padding(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text("${data.postsCount} POSTS",style: const TextStyle(
                    fontSize: 14,
              ...
              Align(
                  ...
                  child: Container(
                    ...
                    child: MaterialButton(onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => PostDetailsScreen(socialGroupId: data.id,)));
                    },
