      ...
      (context, index) {
        return BlocBuilder<PostsCubit, PostsState>(
          builder: (context, state) {
            ...
            //                     padding: const EdgeInsets.symmetric(
            //                         horizontal: AppSizes.s20, vertical: AppSizes.s15),
            //                     child: ImageAndNameSection(user: postResponse.data[index].user,),
            //                   ),
            //                   gapH16,
            //                   PostText(post: postResponse.data[index],),
            //                   postResponse.data[index].image != null && postResponse.data[index].image!.isNotEmpty?
            //                   PostMedia(post: postResponse.data[index],)
            //                       : Container(),
            //
            ...
            //                   PostVideo(post: postResponse.data[index],)
            //                       : Container(),
            //                   PostCommentAndTime(post: postResponse.data[index], socialGroupId: socialGroupId, index: index, user: postResponse.data[index].user,),
            //                 ],
            //               ),
            //             ),
            //           ),
