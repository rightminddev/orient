                    ...
                    bottomNavigationBar: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            if (teamsViewModel.teamDetails != null && s1Cache['user_id'] != teamsViewModel.teamDetails!.owner!.id  &&!teamsViewModel.teamDetails!.members!.contains("${s1Cache['user_id']}") && s1Cache['user_team'] != null&&s1Cache['user_team']['id'] != teamsViewModel.teamDetails!.id)
                            ...
                            gapW10,
                            if (s1Cache['user_team'] != null )
                              if(teamsViewModel.teamDetails!.members!.contains("${s1Cache['user_id']}") || s1Cache['user_team']['id'] == teamsViewModel.teamDetails!.id)
                              CustomButtonBottomSheet(
                                  ...
                                  function: () async {
                                   await defaultActionBottomSheet(
                                       ...
                                       home: false,
                                        ...
                                        view: teamsActionsViewModel
                                            .isLoading,
                                        viewDropDownButton: (UserSettingConst
                                            .userSettings!
                                            .userId ==
                                            teamsViewModel
                                                .teamDetails!
