            ...
            return Consumer<HomeViewModel>(
                builder: (context, value, child) {
                 return Scaffold(
                    ...
                    body: (teamsViewModel.teamDetails == null && teamsViewModel.isLoading)?
                    TeamMemmberLoading()
                        :GradientBgImage(
                            ...
                            sliver: SliverToBoxAdapter(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  gapH6,
                                  Container(
                                    height: (teamsViewModel.teamDetails!.members!.length == 1)? 100 :
                                    (teamsViewModel.teamDetails!.members!.length == 2)? 200 : 300 ,
                                    alignment:(teamsViewModel.teamDetails!.members!.isNotEmpty)? Alignment.topCenter: Alignment.center,
                                    child: (teamsViewModel.teamMembers!.isNotEmpty)?
                                    ListView.builder(
                                      itemCount: teamsViewModel.teamMembers!.length,
                                      shrinkWrap: true,
                                      padding: EdgeInsets.zero,
                                  ...
                                  gapH18,
                                  if(widget.admin == true && widget.roles == "owner")Text(
                                  ...
                                  gapH12,
                                  if(widget.admin == true && widget.roles == "owner" &&teamsViewModel.teamDetails! != null) Container(
                                    color: Colors.transparent,
                                    height: (teamsViewModel.teamDetails!.members!.length == 1)? 100 :
                                    (teamsViewModel.teamDetails!.members!.length == 2)? 200 : 250 ,
                                    alignment:(teamsViewModel.teamDetails!.members!.isNotEmpty)? Alignment.topCenter: Alignment.center,
                                    child: (teamsViewModel.teamDetails!.members!.isNotEmpty)?
                                    ListView.builder(
                                      itemCount: teamsViewModel.requestMembers.length,
                                      shrinkWrap: true,
                                      ...
                                      itemBuilder: (context, index) {
                                        return TeamMembersRequestListViewItem(
                                            teamId: widget.id,
                                            isAdd: true, member: teamsViewModel.teamDetails!.members, index: index
                                        );
                                      },
                                    ):Center(
                                      child: Text(
                    ...
                    bottomNavigationBar:(value.userSettings?.userTeam == null)?Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            if(widget.admin == false) CustomButtonBottomSheet(
                            ...
                            gapW10,
                            if(widget.admin == true)  CustomButtonBottomSheet(
                                ...
                                function: () {
                                  defaultActionBottomSheet(
                                      ...
                                      view: teamsActionsViewModel.isLoading,
                                      viewDropDownButton: (widget.roles == "owner" )? true: false,
