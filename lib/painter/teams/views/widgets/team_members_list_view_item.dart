...
class TeamMembersListViewItem extends StatelessWidget {
  ...
  int index;
  TeamMembersListViewItem({super.key,this.teamId, this.isAdd = false, required this.member, required this.index, this.owner});
  @override
          ...
          return (member![index].pivot!.status != "pending")? Container(
              ...
              child: Row(
                ...
                children: [
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: CachedNetworkImage(
                              imageUrl: (member![index].avatarUrl != null)? member![index].avatarUrl ?? "" : "",
                              height: 40,
                              width: 40,
                              fit: BoxFit.cover,
                              placeholder: (context,
                  ...
                  if(owner == true)Container(
                    alignment: Alignment.centerRight,
                    width: MediaQuery.sizeOf(context).width * 0.4,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.end,
                      children: [
                        if(value.isLoading) Container(
                            padding: const EdgeInsets.symmetric(
                                horizontal: AppSizes.s20, vertical: 9),
                            child: Center( child: CircularProgressIndicator(),)),
                        if(!value.isLoading)InkWell(
                          onTap: () {
                            defaultActionBottomSheet(
                              ...
                              onTapButton: (){
                                value.deleteUser(context, teamId, member![index].id!);
                              },
