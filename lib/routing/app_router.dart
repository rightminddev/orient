              ...
              routes: [
                ...
                GoRoute(
                  ...
                  pageBuilder: (context, state) {
                    ...
                    final id = int.parse(state.pathParameters['id'] ?? '0');
                    final odoo = state.pathParameters['odoo'];
    ...
    ShellRoute(
      ...
      routes: [
        GoRoute(
            ...
            routes: [
              GoRoute(
                path: 'single-product/:id/:viewPrice',
                parentNavigatorKey: _rootNavigatorKey,
                name: AppRoutes.ecommerceSingleProductDetailScreen.name,
                pageBuilder: (context, state) {
                  // Offset? begin = state.extra as Offset?;
                  final idString = state.pathParameters['id'];
                  final viewPrice = state.pathParameters['viewPrice'];
                  if (idString == null) {
                  ...
                  return AppRouterTransitions.slideTransition(
                    key: state.pageKey,
                    child: EcommerceSingleProductDetailScreen(id, viewPrice),
                    animation: animationController,
                    begin:  const Offset(1.0, 0.0),
                  );
                },
...
// Make sure to dispose the controller after the transition is complete
              ...
              GoRoute(
                path: 'search_view/:id/:arrow/:categoryName/:painter',
                parentNavigatorKey: _rootNavigatorKey,
                ...
                pageBuilder: (context, state) {
                  ...
                  final painter = state.pathParameters['painter'] ?? "";
                  if (idString == null) {
                    throw Exception('Product ID is required');
                  }
                  final id = int.tryParse(idString);
                  ...
                  return AppRouterTransitions.slideTransition(
                    ...
                    child: ECommerceSearchScreen(categoryId: id,
                      viewArrow: (arrowString == "yes")? true: false,categoryName: categoryName,
                    painter: painter ,
                    ),
                    animation: animationController,
                    begin:  const Offset(1.0, 0.0),
        ...
        GoRoute(
          ...
          GoRoute(
            path: '/:lang/searchEcommerce/:id/:arrow/:categoryName/:painter',
            parentNavigatorKey: _shellNavigatorKey,
            ...
            pageBuilder: (context, state) {
              ...
              return AppRouterTransitions.slideTransition(
                key: state.pageKey,
                child: ECommerceSearchScreen(categoryId: id,
                  viewArrow: arrow ,categoryName: categoryName,
                painter: painter,
                ),
                animation: animationController,
                begin: begin ?? const Offset(1.0, 0.0),
