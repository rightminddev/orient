...
MerchantNavbarPages getMerchantNavbarPage(
  ...
  if (currentLocationRoute.contains('merchant-notification-screen')) {
    return MerchantNavbarPages.notifications;
  }
  if (currentLocationRoute.contains('more')) {
...
GoRouter goRouter(BuildContext context) => GoRouter(
      ...
      routes: [
        ...
        GoRoute(
          path:
              '/:lang/notification-details-screen/:title/:image/:contant/:date',
          parentNavigatorKey: _rootNavigatorKey,
        ...
        ShellRoute(
          ...
          routes: [
            ...
            GoRoute(
              path: '/:lang/merchant-notification-screen',
              parentNavigatorKey: _shellNavigatorKey,
